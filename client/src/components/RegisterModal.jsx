        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <div className="border-t border-slate-800 my-2 pt-2">
            ...
            <div className="grid grid-cols-2 gap-2.5">
              {/* EXP */}
              <div className="bg-slate-800/50 p-2 rounded-xl border border-slate-800 flex items-center gap-2.5">
                <ExpLaneIcon className="w-8 h-8 flex-shrink-0" />
                <div className="w-full">
                  <label className="text-[10px] text-slate-400 font-bold uppercase block">EXP Lane</label>
                  <input required placeholder="Player IGN" className="w-full bg-slate-900 border border-slate-700 rounded px-2 py-0.5 text-xs text-white focus:border-cyan-500 outline-none mt-0.5"
              ...
              {/* CORE */}
              <div className="bg-slate-800/50 p-2 rounded-xl border border-slate-800 flex items-center gap-2.5">
                <CoreIcon className="w-8 h-8 flex-shrink-0" />
                <div className="w-full">
              ...
              {/* MID */}
              <div className="bg-slate-800/50 p-2 rounded-xl border border-slate-800 flex items-center gap-2.5">
                <MidLaneIcon className="w-8 h-8 flex-shrink-0" />
                <div className="w-full">
              ...
              {/* GOLD */}
              <div className="bg-slate-800/50 p-2 rounded-xl border border-slate-800 flex items-center gap-2.5">
                <GoldLaneIcon className="w-8 h-8 flex-shrink-0" />
                <div className="w-full">
              ...
              {/* ROAM */}
              <div className="bg-slate-800/50 p-2 rounded-xl border border-slate-800 flex items-center gap-2.5">
                <RoamIcon className="w-8 h-8 flex-shrink-0" />
                <div className="w-full">
              ...
              {/* 6TH MAN */}
              <div className="bg-slate-800/50 p-2 rounded-xl border border-orange-500/30 flex items-center gap-2.5">
                <SixthManIcon className="w-8 h-8 flex-shrink-0" />
                <div className="w-full">
                  <label className="text-[10px] text-orange-400 font-bold uppercase block">6th Man (Sub)</label>
                  <input required placeholder="Player IGN" className="w-full bg-slate-900 border border-orange-500/40 rounded px-2 py-0.5 text-xs text-white focus:border-orange-400 outline-none mt-0.5"
